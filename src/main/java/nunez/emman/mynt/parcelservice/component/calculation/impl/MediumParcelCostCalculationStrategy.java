 ...
 */
@Component
public class MediumParcelCostCalculationStrategy extends ParcelCostCalculationStrategy {
    ...
    public BigDecimal calculateCost(final ParcelInfo parcelInfo) {
        return calculateParcelPerVolume(parcelInfo.getVolume(), parcelDeliveryProperty.getMediumParcelCostPerVolume());
    }
